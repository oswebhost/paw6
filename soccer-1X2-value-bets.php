	...
	<tr>
		...
		<td>
		  	<select size="1" name="calltype" class="text" style="width:160px;" >
                <option value="1" <?php if($calltype==1) echo 'selected';?>>Home Win Calls</option>
                <option value="2" <?php if($calltype==2) echo 'selected';?>>Away Win Calls</option>
		  </select>
		 </td>   
		...
		<td>
		  	<select size="1" name="sortby" class="text" style="width:160px;">
                <option value="5" <?php if($_GET['sortby']==5) echo 'selected';?>>Home Odds</option>
                <option value="6" <?php if($_GET['sortby']==6) echo 'selected';?>>Away Odds</option>
...
?>
	...
	<tr <?php echo rowcol($number);?>>
		...
		<td class='ctd <?php echo $pr . $asl_class;?>'><?php echo $row['hgoal'] . dash() . $row['agoal'];?></td>
		
		<?php if ($weekno <> cur_week($db)){ ?>
			<td class='ctd <?php echo $asl_class;?>'><?php echo $row['h_s'] . dash() . $row['a_s'];?></td>
		<?php }?>
	
		<td class='ctd <?php echo $hor;?> <?php echo ($_sortby=='h_odd'? "bgcolor='#D3EBAB'": "");?>'><a class='<?php echo $sbar;?>' href="javascript:tell('full_odds.php?id=<?php echo $matchno;?>&db=<?php echo $db;?>')"><?php echo show_odd($row['h_odd']);?></a></td>
		
		<?php if ($weekno == cur_week($db)){ ?>	
				<td class='ctd' ><?php echo show_odd($row['d_odd']);?></td>
		<?php } ?>

		<td class='ctd <?php echo $aor;?> <?php echo ($_sortby=='a_odd'? "bgcolor='#D3EBAB'": "");?>'><a class='<?php echo $sbar;?>' href="javascript:tell('full_odds.php?id=<?php echo $matchno;?>&db=<?php echo $db;?>')"><?php echo show_odd($row['a_odd']);?></a></td>
		<td class='ctd' <?php echo ($_sortby=='overround'? "bgcolor='#D3EBAB'": "");?>><a title='Over Round Details' class='sbar' href="javascript:OrWin('overround.php?db=<?php echo $db;?>&id=<?php echo $matchno;?>')"><?php echo num20($or->match_or);?>%</a></td>
		<td class='ctd' <?php echo ($_sortby=='hover'? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['hover']);?></td>
		<td class="ctd" <?php echo ($_sortby=='dover'? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['dover']);?></td>
		<td class="ctd" <?php echo ($_sortby=='aover'? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['aover']);?></td>
...
<?php if ($weekno <> cur_week($db)){ ?>	
   <tr bgcolor="#f4f4f4">                  
    ...
    <td colspan="2" class="ctd padd bot"><?php echo $dcc; ?></td>
    <td colspan="6"></td>
  </tr> 

  <tr bgcolor="#f4f4f4">
    <td colspan="3" class="rtd padd bot">Total Correct Calls</td>
    <td colspan="2" class="ctd padd bot"><?php echo $ngot; ?></td>
    <td colspan="6"></td>
  </tr> 
 <tr bgcolor="#f4f4f4">
 ...
 <tr bgcolor="#f4f4f4">
    ...
    <td colspan="2" class="ctd padd bot"><?php echo $ppp; ?></td>
    <td colspan="6"></td>
  </tr> 
<?php } ?>
