...
$page_title = "Betting Advice For Advanced Bettors";

$show_key= meta_bettingadvice();
$desc = "Detailed advice on advanced betting systems and how they work, complete with downloadable spreadsheets to assist in their implementation. ";
...
<?php if (!isset($_POST['searchfor'])){  ?>
	...
	<?php
		...
		$catid = 2; //betting-advice-for-advanced-bettors
	?>
		<ol>
			<?php 
