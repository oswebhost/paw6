...
$qry2 = "select date_format(match_date,'%d-%b-%Y') as mdate,hteam,ateam,h_odd, d_odd, a_odd,match_time from fixtures where season='$sea' and mid='$id'";
...
<title><?php echo $d["hteam"] . " v ". $d["ateam"] . " Odds" ;?></title>

</head>
<body>
<?php page_header("Match Odds") ; ?>
<center>
...
<div style="margin-top:0px;padding:2px;border:1px solid #ccc;font-size:13px;color:#0000ff;background:#fff;">	
	    <table width='100%'>
		<tr>
			<td colspan='2' class='ctd'><font color='blue' size='+1'><?php echo $d["hteam"] ?></font>
			<font color='gray' size='+1'>&nbsp;v&nbsp;</font> <font color='red' size='+1'><?php echo $d["ateam"] ?></font>
				
			</td>
		</tr>
		<tr>
			<td colspan='2' class='ctd'><font size='2'><?php echo $d["mdate"]. "&nbsp;<font size='1'>" . substr($d['match_time'],0,5) . "</font>";  ?></font></td>
		</tr>
		...
		<table border='1' width='350' cellpadding='3' style="border-collapse: collapse" bordercolor="#999999">
		 ...
		 <tr>
		  ...
		  <tr>	
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($d["h_odd"]); ?></td>
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($d["d_odd"]); ?></td>
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($d["a_odd"]); ?></td>
		  </tr>
		</table>
		<?php echo bookie_name("BET"); ?>
	...
	<?php  
	   ...
	   if ($dd["hw_x"]>0): ?>
		...
		<table border='1' width='350' cellpadding='3' style="border-collapse: collapse" bordercolor="#999999">
		 ...
		 ?>
		  <tr>	
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($dd["hw_x"]); ?></td>
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($dd["aw_x"]); ?></td>
			  <td class='ctd odds' bgcolor='#ffffff'><?php echo num2($dd["hw_aw"]); ?></td>
		  </tr>
		</table>
		<?php echo bookie_name((strlen($dd["dchance"])>0 ? $dd["dchance"] : "BET")); 
		   endif;
		?>
	  ...
	  <?php if ($dd["ht_hh"]>0): ?>
		...
		<table border='1' width='350' cellpadding='3' style="border-collapse: collapse" bordercolor="#999999">
		 ...
		 <tr>
			...
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_hh"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>2/1</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_ah"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>X/1</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_dh"]);?></td>
		 </tr>

		 <tr>
			<td width='16%' class='ctd odds' style='border-right:0;'><b>1/2</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_ha"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>2/2</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_aa"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>X/2</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_da"]);?></td>
		 </tr>
		 <tr>
			<td width='16%' class='ctd odds' style='border-right:0;'><b>1/X</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_hd"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>2/X</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_ad"]);?></td>

			<td width='16%' class='ctd odds' style='border-right:0;'><b>X/X</b></td>
			<td width='16%' class='ctd odds' bgcolor='#ffffff' style='border-left:0;'><?php echo num2($dd["ht_dd"]);?></td>
		 </tr>
		...
		<table width='100%' cellpadding='0'>
		 <tr>
			...
			<tr>
				<td class='ctd odds' bgcolor='#ffffff' width='50%'><?php echo num2($dd["un_odd"]);?></td>
				<td class='ctd odds' bgcolor='#ffffff' width='50%'><?php echo num2($dd["ov_odd"]);?></td>
			</tr>
			</table>
			<?php echo bookie_name((strlen($dd["underover"])>0 ? $dd["underover"] : "BET")); 
			   endif;
			?>
			...
			<tr>
				<td class='odds' width='75%'><?php echo $d["hteam"] ?></td>
				<td class='ctd odds' width='25%' bgcolor='#ffffff'><?php echo num2($dd["hw_odd"]); ?></td>
			</tr>
			<tr>
				<td class='odds'><?php echo $d["ateam"] ?></td>
				<td class='ctd odds' bgcolor='#ffffff'><?php echo num2($dd["aw_odd"]); ?></td>
			</tr>
			
			</table>
			<?php echo bookie_name((strlen($dd["winonly"])>0 ? $dd["winonly"] : "BET")); 
			   endif;
			?>
	...
	<tr>
     ...
     <tr>
		<td class='odds'><?php echo $d["hteam"] ?></td>
		<td class='odds ctd' bgcolor='#ffffff'><?php echo $ahb["ht_hcap"];?></td>
		<td class='odds ctd' bgcolor='#ffffff'><?php echo num2($ahb["ht_odd"]);?></td>
	</tr>
	<tr>
		<td class='odds'><?php echo $d["ateam"] ?></td>
		<td class='odds ctd' bgcolor='#ffffff'><?php echo $ahb["at_hcap"];?></td>
		<td class='odds ctd' bgcolor='#ffffff'><?php echo num2($ahb["at_odd"]);?></td>
	</tr>
    </table>   
	<?php echo bookie_name("BET"); 
	   endif;
