...
<div style='padding:5px;color:#ff0000;font-size:14px;text-align:center;'>
  <a class='sbar' href='download.php?week=<?php echo $WEEK . "&site=$db"; ?>'><img src='images/download.jpg' border='0' alt='Download Excel File' /></a>
</div>
...
<tr>
	<td> </td>
	<td align="right"> <?php $pageURL ="?season=$SEASON&site=$db";  echo printscr(); ?></td>
</tr>
</table>
