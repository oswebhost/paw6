...
require_once("asianhandycap-class.php");
...
<tr>
  <td width='10%'> <a class='sbar' href="bookies-odds-soccer-betting.php?db=<?php echo  $db;?>"><img border="0" src="images/header/blue-dot.gif"/>Back</a> </td>
...
<table border="0" cellpadding="4" cellspacing="0" style="border:1px solid #ccc;margin:auto auto;background:#E1EFFD;" bordercolor="#f4f4f4" width="560">
      ...
      <td style='text-align:left;padding:10px 0 10px 0;'><b><font size="2" color="#0000FF">Bookie's Perception:</font></b>
        <select style="width:130px;" name="callfor" class="text">
            <option value="1" <?php if($_GET['callfor']==1) echo 'selected';?>>Home Strong</option>
            <option value="2" <?php if($_GET['callfor']==2) echo 'selected';?>>Away Strong </option>
            <option value="3" <?php if($_GET['callfor']==3) echo 'selected';?>>Equal Strength</option>

            <option value="4" <?php if($_GET['callfor']==4) echo 'selected';?>>Home Strong / Home Win</option>
            <option value="5" <?php if($_GET['callfor']==5) echo 'selected';?>>Home Strong / Away Win</option>

            <option value="6" <?php if($_GET['callfor']==6) echo 'selected';?>>Away Strong / Away Win</option>
            <option value="7" <?php if($_GET['callfor']==7) echo 'selected';?>>Away Strong / Home Win</option>

            <option value="8" <?php if($_GET['callfor']==8) echo 'selected';?>>Equal Strength / Home Win</option>
            <option value="9" <?php if($_GET['callfor']==9) echo 'selected';?>>Equal Strength / Away Win</option>
    ...
    <td style='text-align:left;padding:10px 0 10px 0;width:170px;'><b><font size="2" color="#0000FF">Filter:</font></b>
        <select style="width:155px;" name="filteron" class="text">
            <option value="1" <?php if($_GET['filteron']==1) echo 'selected';?>>All Matches</option>
            <option value="2" <?php if($_GET['filteron']==2) echo 'selected';?>>Full/Half No. Handicap</option>
            <option value="3" <?php if($_GET['filteron']==3) echo 'selected';?>>Quarter Handicap</option>
        </select>
    </td>
		...
		<td style='padding:10px 0 10px 0;'><b><font size="2" color="#0000FF">For:</font></b>
          ...
          <option value="1" <?php if($_GET['formatch']==1) echo 'selected';?>>Full Week (Mon - Sun)</option>
          <option value="2" <?php if($_GET['formatch']==2) echo 'selected';?>>Weekend (Sat - Sun)</option>
          <option value="3" <?php if($_GET['formatch']==3) echo 'selected';?>>Midweek (Mon - Fri)</option>
...
?>
    ...
    <?php if ($_GET['callfor']==2){?>
      <td class="ctd"><?php echo  num0($row['agoal'] - $row['hgoal']); ?></td>
    <?php }else{ ?>  
      <td class="ctd"><?php echo  num0($row['hgoal'] - $row['agoal']); ?></td>
    <?php } ?>

		<td class='ctd'><?php echo ($row['ht_hcap']>0? $row['ht_hcap']: "0")."/" .($row['at_hcap']>0? $row['at_hcap']: 0) ;?></td>
		
    <?php if($row['ht_odd']<$row['at_odd']){?>
    ...
    <?php } ?>  
       ...
       <?php } ?>
        ...
        <?php if($weekno<>cur_week($db)){?>
          ...
          <td class="ctd"><a class='md' href="javascript:tell('full_odds.php?id=<?php echo  $matchno;?>&db=<?php echo  $db;?>')">
            <?php if(strlen($act)<2){
              echo "Odds";
            }else{
          ...
          <?php if (strstr($ahb->vchar, "W")){ ?>
            <td class="ctd gotrt"><?php echo  $ahb->vchar; ?></td>
          <?php }else{ ?>
            <td class="ctd"><?php echo  $ahb->vchar; ?></td>
          <?php } ?>
