  ...
  // $xx = "CREATE TABLE " . $filename . " (".$query1.")";
   ...
   if ($db=='eu'){
	...
	while ($rows = $temp->fetch()){
		...
		$over_outcome = 0; $under_outcome = 0; $dc_outcome = 0; $win_outcome = 0; $no_win_bet = 0; $weekly_correct = 0; $_BOOKIECALL = 0 ;
...
?>
	...
	<tr <?echo rowcol($weekno);?>>
		...
		<?php $Tcorect_calls += $weekly_correct; ;?>
