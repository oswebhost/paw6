...
if (check_season('eu')=='1' and check_season('sa')=='1' ){ 
...
<tr>
    <td colspan="2" bgcolor='#ECECFF' class="credit ctd"><?php echo  site('eu');?></td>
</tr>
<tr>
...
<table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse" bordercolor="#004E9B" width="85%" >
  <tr>
    <td colspan="2" bgcolor='#ECECFF' class="credit ctd"><?php echo  site('sa');?></td>
</tr>
<tr>
<?php 
...
<a href="<?php echo $domain?>/ba/using-the-blank-ease-spreadsheets.php" class="prv">Using the "Blank" EASE Spreadsheet</a>
