...
elseif (!isset($_SESSION['userid']) and ($weekno==cur_week($db))) :
 ...
 $qry = "SELECT c.*,abs(c.gpr_dif) as gprdif,f.match_time,f.hgoal,f.agoal,f.h_s,f.a_s,f.gotit,
 ...
 and c.season='$season' and c.matchno=f.mid and f.season=c.season and f.weekno=c.weekno" ;
  ...
  switch ($_GET['SORTBY'])
  {
    ...
    case 3: $ordered_by .= " ORDER BY gprdif ";  break;
...
<tr <?echo rowcol($number);?>>
    ...
    <td class="ctd" <?echo ($_GET["SORTBY"]=='4'? "bgcolor='#D3EBAB'": "");?>><?echo ($row["gpr_av"]); ?></td>
    <td class="ctd"><?echo ($row["gprdif"]); ?></td>
