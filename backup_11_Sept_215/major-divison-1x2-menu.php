		...
		<table border="1" width="570" align="center" bordercolor="#EBEBF3" cellspacing="0" style="border-collapse: collapse" cellpadding="4">
			...
			<tr>
				...
				<? if (gg_count('C0','n/a','FIXTURE')>0) :
				  ...
				  echo '<A class="' . $cla . '" HREF="1x2-predictons.php?PARA=C0'.$wk.'">Coca-Cola Championship' ;
			...
			<tr>
				...
				<? if (gg_count('C1','n/a','FIXTURE')>0) :
				  ...
				  echo '<A class="' . $cla . '" HREF="1x2-predictons.php?PARA=C1'.$wk.'">Coca-Cola League 1' ;
				...
				<? if (gg_count('C2','n/a','FIXTURE')>0) :
				  ...
				  echo '<A class="' . $cla . '" HREF="1x2-predictons.php?PARA=C2'.$wk.'">Coca-Cola League 2' ;
