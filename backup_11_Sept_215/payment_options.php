...
<div style='padding:10px;padding-top:0;text-align:left; font-size:13px;'>

<p style='padding-top:5px'>You will only be able to pay us by using the <span class='bb'>SKRILL DIGITAL WALLET</span> payment process.  If you don't already have a Skrill Account then, after you have selected the <span class='bb'>Services Package</span> you require, simply click on the "Continue" button to be taken to the next screen.  There you will be able to sign up with Skrill to open a <a href='https://www.skrill.com/en/digital-wallet/' target='_blank'><b><i>Digital Wallet</i></b></a>  account.  It's safe, because we won't see your registration details; the screen opens on Skrill's web server, which is not linked to us in any way.</p>     

<p>Before proceeding further, please also read the <span class='bb' style='color:#852064;font-size:14px;'>ESSENTIAL NOTES</span> under the below listing of "SERVICES PACKAGES AVAILABLE".</p>
...
<img src='images/skrill-payby-150x83_en.gif' border='0' style='padding-left:50px;padding-top:10px;	' />
