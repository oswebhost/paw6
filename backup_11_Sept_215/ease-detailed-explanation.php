...
<p>The simple truth here is that our most reliable predictions in percentage terms are the Home Win "Short Odds" Calls under the "<B>Segregated Selections</B>" section, but you will never make your fortune there. The best you are ever likely to do is end up with 10% more in your pocket at the end of the season, if you are lucky.  </p> 

<p>Because "favourites" often go wrong and produce Draws, you could try betting "Double Chance" using our "Medium Odds" Calls. But you will almost certainly not do any better overall there than by laying out on Outright Wins for the same matches.   </p>   

<p>What we ourselves prefer to go for is Correct Scores multiple-line betting, using 6 "special" matches where both teams are expected (but, of course, they can never be "relied upon") to score near enough the exact number of goals our Program has predicted (the "Anticipated Score-Lines").</p> 
...
<ol style='padding-left:50px;'>
	...
	<li>The Bookies must also be truly regarding the match as a potential HOME WIN (meaning that the "Win Only" Odds must be (i) much lower for the Home Team and (ii) not too near to the Away Team's "Win Only" Odds (otherwise it indicates a hedged call by the Bookie  - i.e. a potential Draw)). However, due to the lack of sufficient numbers of “comfortable” Home Win calls, sometimes we are forced to include matches where our Program is expecting a Draw.</li>
	...
	<li>The Double Chance Odds must be at least 1.10 but not over 1.35.</li>

	<li>We then check the League Tables to see exactly where the teams stand in relation to each other, although in the early part of the season this is far less meaningful. Where the Home team is way down below the Away team, then we drop that match, but by mid-season we will often include a match where the Home team is below the Away team (but by no more than 3 rungs).</li>
	...
	<li>And finally, if there are any big surprises in quite recent results for previous weeks (a bad loss when an easy win was expected), then we drop such a match. This is especially important where the match is lower down on the list of Current 1X2 Reliabilities, because it could be the result of such a team's sole star player not contributing properly (which can happen for a variety of reasons).</li>

</ol>

<p>Where 6 matches meeting all the above criteria can't be found, we add in the balance of matches to make up the required 6 on the following basis:</p>

<ol type='i' style='padding-left:50px;'>
	<li>We identify those "favourites" matches where the stronger Home teams are expected to win by a margin of at least 2 goals (i.e. 2-0, 3-1, 3-0, 4-0, etc.) and go for the "Outright Win" call, not the Double Chance call.</li>

	<li>From amongst those "favourites", we then select matches where the score-lines for the Home team are the most consistent compared to the strength of the opponents. This means that we look for progressively bigger positive goal differences where the opponent's apparent weakness increases.</li>

	<li>The Home team's reliability (or otherwise) regarding actual score-lines is taken into account when deciding on hedge betting score-lines, and our guiding principle is to select those "favourites" matches we are most comfortable with overall.</li>
</ol>
...
<p>For those Clients who have more time available plus the inclination to do research across a range of alternative matches, we also produce a BLANK "<B>EASE</B>" spreadsheet (accessible under "<B>DATA for MEMBERS</B>"), which enables our Clients to select and analyse the data for any 6 matches of their own choosing in exactly the same way as we do for our weekly-posted "<B>EASE 6</B>".</p>
