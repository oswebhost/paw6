...
<style>
  ...
  .ldark {border-left:2px solid #333;}
...
function revCall($no,$secondPara){
	...
	if ($secondPara < 4){
		...
		{	
			...
			case 20: $rvcall = "Double Chance 1/X"; break;
			case 21: $rvcall = "Double Chance 1/2"; break;
			case 22: $rvcall = "Double Chance 2/X"; break;
			
			case 25: $rvcall = "Away Win Only (D=NB)"; break;
			case 26: $rvcall = "Home Win Only (D=NB)"; break;
...
<tr bgcolor="#f4f4f4">
    ...
    <td colspan="<?echo ($_GET['BETTING']>1? 7 : 6 ); ?>" class="rtd padd bot">Postponed/Void Matches&nbsp;</td>
...
<?
 ...
 $summaryURL = "javascript:tell('weekbyweeksummaryV4.php?" . substr($url, 0, strlen($url)-14) ."')" ;
?>
...
<a href="javascript:tell('weekbyweeksummaryV4.php?db=eu&season=2015-2016&weekno=26&DIV=1&BETTING=1&SORTBY=10&ordered=1&PERIOD=1&CALL=6&PROPTION=2&ASL2GET=all&limitedto=0&min_odd=1.36&max_odd=1.5&CALLPARAM=0&CALLAS=3')"></a>
