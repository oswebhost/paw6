...
<table width='100%' border='0' cellpadding='2' cellspacing='0' style="border-collapse: collapse;" bordercolor="gray">
 ...
 <tr>
	<td id='xtd3' bgcolor='#EAEAFF'><?= ($ro>0? num2($ddd['col1']):'&nbsp;');?></td>
	<td id='xtd3' bgcolor='#EAEAFF'><?= ($ro>0? num2($ddd['col2']):'');?></td>
	<td id='xtd3' bgcolor='#EAEAFF'><?= ($ro>0? num2($ddd['col3']):'');?></td>
	<td id='xtd3' bgcolor='#EAEAFF'><?= ($ro>0? num2($ddd['col4']):'');?></td>
	<td id='xtd3' bgcolor='#EAEAFF'><?= ($ro>0? num2($ddd['col5']):'');?></td>
	<td id='xtd3' bgcolor='#DFFFDF'><?= ($ro>0? num2($ddd['col6']):'');?></td>
	<td id='xtd3' bgcolor='#DFFFDF'><?= ($ro>0? num2($ddd['col7']):'');?></td>
	<td id='xtd3' bgcolor='#DFFFDF'><?= ($ro>0? num2($ddd['col8']):'');?></td>
	<td id='xtd3' bgcolor='#FFD2D2'><?= ($ro>0? num2($ddd['col9']):'');?></td>
	<td id='xtd3' bgcolor='#FFD2D2'><?= ($ro>0? num2($ddd['col10']):'');?></td>
	<td id='xtd3' bgcolor='#FFD2D2'><?= ($ro>0? num2($ddd['col11']):'');?></td>
	<td id='xtd3' bgcolor='#FFD2D2'><?= ($ro>0? num2($ddd['col12']):'');?></td>
	<td id='xtd5' bgcolor='#FFD2D2'><?= ($ro>0? num2($ddd['col13']):'');?></td>
</tr>
