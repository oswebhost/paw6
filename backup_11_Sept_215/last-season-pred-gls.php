...
<tr>
	...
	<td class='ctd prob chattd'><?= num0($hq['actgf']);?></td>
	<td class='ctd prob chattd'><?= num0($hq['aslgf']);?></td>
	<td class='ctd prob chattd'><?= num0($hq['actga']);?></td>
	<td class='ctd prob chattd'><?= num0($hq['aslga']);?></td>
	<td class='ctd' width="4">&nbsp;</td>
	<td class='ctd prob chattd'><?= num0($aq['actgf']);?></td>
	<td class='ctd prob chattd'><?= num0($aq['aslgf']);?></td>
	<td class='ctd prob chattd'><?= num0($aq['actga']);?></td>
	<td class='ctd prob chattd'><?= num0($aq['aslga']);?></td>
...
<tr>
	<td class='ctd prob' bgcolor="#FFCCCC"><?= num0($hq['game']);?></td>
	<td class='ctd prob' ><?= num0($hq['gls4']);?></td>
	<td class='ctd prob' ><?= num0($hq['rt']);?></td>
	<td class='ctd prob' ><?= num0($hq['rtgls']);?></td>
	<td class='ctd prob' ><?= num0($hq['thigh']);?> / <?= num0($hq['tlow']);?></td>
	<td class='ctd' bgcolor="#FFCCCC" ></td>
	<td class='ctd prob' ><?= num0($aq['gls4']);?></td>
	<td class='ctd prob' ><?= num0($aq['rt']);?></td>
	<td class='ctd prob' ><?= num0($aq['rtgls']);?></td>
	<td class='ctd prob' ><?= num0($aq['thigh']);?> / <?= num0($aq['tlow']);?></td>
	<td class='ctd prob' bgcolor="#FFCCCC"><?= num0($aq['game']);?></td>
</tr>
</table>
