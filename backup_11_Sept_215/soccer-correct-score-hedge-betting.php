...
<tr <?echo rowcol($number);?>>
    ...
    <td class="ctd" <?echo ($_GET["SORTBY"]=='1'? "bgcolor='#D3EBAB'": "");?>><?echo ($row["ht_hedge"]); ?></td>
    <td class="ctd" <?echo ($_GET["SORTBY"]=='2'? "bgcolor='#D3EBAB'": "");?>><?echo ($row["at_hedge"]); ?></td>
    <td class="ctd" <?echo ($_GET["SORTBY"]=='4'? "bgcolor='#D3EBAB'": "");?>><?echo ($row["avg_hedge"]); ?></td>
    <td class="ctd"><?echo ($row["hedgedif"]); ?></td>
