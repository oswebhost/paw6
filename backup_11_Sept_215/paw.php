...
<p>Our Program employs 9 very distinct "base" Prediction Methods together with 5 derivative Prediction Methods, and tracks and records many different aspects of the reliability of their outputs. The 5 derivative modules each identify – in separate ways – the best Prediction Method for the two specific teams involved in each particular match, based on the respective reliabilities for both the Result Type and the Correct Scores predictions. As a final step, in order to identify the very best betting selections for the week, the Program sorts the predictions into prioritised lists, based on a combination of the highest reliabilities.</p>


<p>Being structured as a database, our Program gives us the ability to create an endless variety of Reports, limited only by our own imagination. We have been fortunate that many of our Clients have inventive minds and have made many suggestions for our Reports that we have taken on board.</p>
