...
//if (strlen($ref_no)>0 and strlen($_userid)>0):
	...
	Thank you for your subscription. You have been billed <b>". num2($pay_amt) ."</b> in $cur_code via SKRILL. <br><br>

	
	<table border='1' style='border-collapse: collapse' bordercolor='#c4c4c4'  width='60%'>
	<tr><td colspan='2' class='credit' bgcolor='#cccccc'><b>Transaction Details</b></td></tr>
	<tr><td class='f14' width='70%'>SKRILL reference number: </td><td class='f14 rtd'><b>". $ref_no . "</b> </td></tr>
