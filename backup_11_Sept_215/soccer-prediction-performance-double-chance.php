...
<tr bgcolor="#f4f4f4">
    ...
    <td class="ctd padd bot"><?echo $total_matches; ?></td>
    <td class="ctd padd bot"><?echo $total_postponed; ?></td>
    <td class="ctd padd bot"><?echo $total_valid; ?></td>
    <td class="ctd padd bot"><?echo $total_cs; ?></td>
    <td class="ctd padd bot"><?echo $total_correct; ?></td>
