...
<table border="0" width="100%" cellpadding="3" cellspacing="0" style='margin-bottom:5px;'>
 <tr>
    <td width="25%"><a class='sbar' href="soccer-segregated-selections-performance.php?db=<?=$db;?>&<?php echo $cur; ?>"><img border="0" src="images/header/blue-dot.gif" >Back</a></td>
...
<div class="report_blue_heading" style="float:left;width: 560px;"><?echo site($db);?></div>
<div class='clear'></div>
<div class="report_blue_heading" style="width: 560px;height:32px;margin:0 auto 5px auto;">Prime Home Win Calls (Top 6)<br /><?echo prt_bet($bet);?> </div>
