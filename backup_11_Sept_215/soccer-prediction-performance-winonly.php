  ...
  switch ($_GET['PERIOD'])
	...
	for ($week_loop=1; $week_loop<=$mx_week; $week_loop++){
	  	...
	  	$query1 = "SELECT (f.hgoal-f.agoal) as goaldif, (f.hgoal+f.agoal) as goalsum, f.hgoal, f.agoal, f.gotit,
	  	 f.h_s,f.a_s,f.hwinpb,f.awinpb,f.drawpb,f.h_odd,f.a_odd,f.d_odd, f.weekno, f.mid, o.hw_odd, o.aw_odd, f.`div`,
		 ...
		 $week_wrong=0; $week_valid=0;
			...
			if ($match_check>0){
				...
				$mywin = "mywin";
				$window ='<a class="sbar" href="javascript:sele_win(\'weekly-winonly-listing.php';
				$window .= "?" ;
