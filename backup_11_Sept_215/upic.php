<?
$page_title="Soccer Predictions Data Tutorial";
...
<p>First though, we want to touch on (i) the question of the best Bet Type(s) for <B>you</B> to opt for and (ii) how you can easily detect which matches appear to have the best chance of producing the results you are looking for (and which will be those matches where the two respective teams involved have the highest "Performance Reliabilities"):</p>

<ul style='padding-left:50px;padding-top:10px;'>    

<li>Bet Types - Inevitably, our Program will have better success rates for certain types of betting than for others. For example, you can rightly expect that our Home Win predictions will have a greater success rate than for Draw predictions. You can check this out for yourself by clicking on the "<B>Prediction Performance Records</B>" under the section labelled "<B>FREE DATA</B>" in the right-hand menus. Remember though that the Odds for the two Bet Types vary significantly.</li>

<li>Performance Reliabilities – You will see this data if you go to the "<strong>Current 1X2 Reliabilities</strong>" data (under the "<strong>Current Probabilities/Reliabilities</strong>" sub-menu under "<strong>DATA for MEMBERS</strong>"). Simply select the year and week you want to view the details for. </li> 
...
<p>However, it would be much easier if you are reviewing our "<B>EASE 6</B>" selections (utilising the fully completed spreadsheet we prepare) or, if relying on your own selections, utilising the <B>BLANK</B> "<B>EASE</B>" <B>Spreadsheet</B> we produce! </p>  
...
<p>Our Program sorts the predictions into a hierarchy for final selection purposes within each of the Result Types (Home Wins and Away Wins). The higher the ranking of a match is, the stronger our confidence will be in our Program's prediction. If there is no rank number given it simply means that it is a "Minor Division" match (where we provide the predictions free-of-charge to all visitors to our website).</p>
...
<p>The final piece of information in this portion (the "Too Hi/Lo" figures) tells us how many times the Program was too high in its expectations of a team and how many times it gave the team too little credit for its ability (too low). A Draw result is not counted for these purposes, since we regard it as meaning that our Program was neither too high nor too low in its expectations. </p>

<p>The Hi/Lo data has to be considered in the light of how many matches have been played. Where, for example, 10 current matches have been played by a team and the Program predicted too high on 1 occasion and too low also only once, then we would have a lot of confidence in the prediction. On the other hand, if 10 current matches had been played and the Program predicted too high on 4 occasions and too low on another 2 occasions, we would have much less confidence in the latest prediction.</p>
 
 
 <p style="color:blue;font-weight:bold;">(6) Head-to-Head</p>
<p>Where the Head-to-Head results are surprising and don’t seem to have any correlation to the apparent relative strengths of the respective teams, it can often highlight the existence of a "needle/grudge match" situation or a "local derby" you weren’t aware of (and they exist in every country). Where such inconsistencies occur we have found it is best to ignore those particular matches for betting purposes.</p>
