...
?>
	...
	<tr <?php echo rowcol($number);?>>
		...
		<td class='ctd <?php echo $pr;?>' <?echo (($_GET['SORTBY']==13 or $_GET['SORTBY']==14) ? "bgcolor='#D3EBAB'": "");?> ><?echo $row['hgoal'] . dash() . $row['agoal'];?></td>
		<td class='ctd <?php echo $hor;?>' <?echo ($_GET['SORTBY']==10 ? "bgcolor='#D3EBAB'": "");?>><?php echo show_odd($row['h_odd']);?></td>
		<td class='ctd' <?echo ($_GET['SORTBY']==12 ? "bgcolor='#D3EBAB'": "");?>><?php echo show_odd($row['d_odd']);?></td>
		<td class='ctd <?php echo $aor;?>' <?echo ($_GET['SORTBY']==11 ? "bgcolor='#D3EBAB'": "");?>><?php echo show_odd($row['a_odd']);?></td>
		<td class='ctd' <?echo ($_GET['SORTBY']==4 ? "bgcolor='#D3EBAB'": "");?>><a title='Over Round Details' class='sbar' href="javascript:OrWin('overround.php?db=<?php echo $db;?>&id=<?php echo $matchno;?>')"><?php echo num20($or->match_or);?>%</a></td>
		<td class='ctd' <?echo ($_GET['SORTBY']==1 ? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['hover']);?></td>
		<td class="ctd" <?echo ($_GET['SORTBY']==2 ? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['dover']);?></td>
		<td class="ctd" <?echo ($_GET['SORTBY']==3 ? "bgcolor='#D3EBAB'": "");?>><?php echo num20($row['aover']);?></td>
