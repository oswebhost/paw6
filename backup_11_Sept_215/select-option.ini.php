...
<table border="0" cellpadding="2" cellspacing="0" style="margin:auto auto;width:550px">
   	<tr>
        <td width="50%" class="credit padd ctd">
            <a class='mblue' href="<?php $PHP_SELF;?>?db=eu"><img src="images/eurodivs.gif" border='0' alt="European Divisions" /></a> 
        </td>    
        <td width="50%" class="credit ctd padd" style='color:blue;'>
            <a class="mblue" href="<?php $PHP_SELF;?>?db=sa"><img src="images/sadivs.gif" border='0' alt="American Divisions" /></a>
        </td>
    </tr>
 </table>