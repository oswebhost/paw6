...
<ol style='padding-left:50px;'>
  ...
  <li>From the previous season's data we first calculate each team's Home and Away "Win Quotients" (WQ's), together with their respective "Scoring Abilities" (SA's) and "Vulnerabilities" (VU's) - (the meanings of these terms being, we hope, reasonably obvious). That data allows us to rank the teams one against the other in last season's Divisions.</li>
  
  <li>For very sound statistical reasons, for match prediction purposes we do not use data from any further back than the previous season. And don't let anyone try to convince you that data from 2 or more seasons back is relevant, because it isn't and never could be!</li>
 ...
 <ol style="list-style-type:lower-roman;padding-top:10px;padding-left:30px;">
    ...
    <li>The middle shade is used to represent the "true" past results for all matches played in the previous season where those fixtures have yet to be played in the new season.The middle shade is used to represent the "true" past results for all matches played in the previous season where those fixtures have yet to be played in the new season.</li>
 ...
 <ol style="list-style-type:lower-roman;padding-top:10px;padding-left:30px;">
    ...
    <li>the score when the two teams last played each other (but only as far back as the previous season's result - and for certain Scottish matches it may refer to an earlier match in the current season);</li>

    <li>the WQ's, SA's and VU's for each team, showing (a) the Current Value, (b) the Starting Value and (c) the Projected Value (which our Program uses in the calculations);</li>
    ...
    <li>Head-to-Head stats (going back 19 years for all UK Divisions and 8 years for all other European Divisions); </li>   

    <li>the current season's results to date for the Home Team at Home and when Away and for the Away Team when Away and at Home, together with a comparison with (and successes of) our Program's "Anticipated Score-Line" (ASL);</li>
...
<p>As we have also observed elsewhere, if you look back at the PIC for a previous week, all reports AFTER the "PREDICTION BACKUP & USEFULNESS DATA" (i.e. from "Prediction Accuracy This Season for Home Team" on and downwards) will include all the FIXTURES and RESULTS information right up to the current week (this is due to a server storage limitation problem).</p>
