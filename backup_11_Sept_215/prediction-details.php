...
//$last_season = ($db=='eu'? '2013-2014' : '2014');
...
<tr <?echo rowcol($number);?>>
    ...
    <td class="ctd"><a title='<?echo $title?>' href="javascript:tell('full_odds.php?id=<?echo $matchno?>&db=<?echo $db?>')" class='sbar'><?echo show_odd($row["asl_odd"])?></a></td>
