...
<div style='text-align:center;width:528px; margin:auto auto;border:1px solid #000;background:#E9EFFF;padding:5px;font-size:13px;line-height:140%;margin-top:12px;border-bottom:0'>
...
representing our Program's topmost favoured call(s) for each Division covered.  <b>They do not represent our Top 
6 Prime Selections!</b> We have <span class="bb"><? echo $Total_No_Matches;?></span> predictions this week (<?php
 echo trim($week_perid); ?>); to see ALL of them (plus the full backup details) you need to be a <span class=
'bb' style='color:maroon'>Registered Member</span> and log in first. But you won't have to pay anything at all, 
<span class="bb">because it's all completely free-of-charge!</span>
...
<div style="border:0px solid #000;width:540px;margin:0 auto 0 auto;padding:0;border-top:0px;">
...
<div style="border:0px solid #23488C;width:540px;margin:0 auto 0 auto;padding:0;border-top:0px;">
