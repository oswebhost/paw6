...
<div style="margin-top:0px;padding:2px;border:1px solid #ccc;font-size:13px;color:#0000ff;background:#fff;">	
	    <table width='100%'>
		<tr>
			<td colspan='2' class='ctd'><font color='blue' size='+1'><? echo $d["hteam"] ?></font>
			<font color='gray' size='+1'>&nbsp;v&nbsp;</font> <font color='red' size='+1'><? echo $d["ateam"] ?></font>
				
			</td>
		</tr>
		<tr>
			<td colspan='2' class='ctd'><font size='2'><? echo $d["mdate"]. "&nbsp;<font size='1'>" . substr($d['match_time'],0,5) . "</font>";  ?></font></td>
		</tr>
