...
if ($loc =="Home" ): 
	...
	$q2= "";//"select season,date_format(match_date,'%d-%b-%y') as mdate,ateam,`div`,h_s,a_s from `last_season_pred` where hteam='$home' and ateam='$away' and season in ('2009-2010','2008-2009','2007-2008') order by season desc, match_date desc";
...
elseif ($loc =="Away" ): 
	...
	$team = $_SESSION['away'] ; 
	//$q1= "select season,mdate,ateam,`div`,h_s,a_s from `last_season_pred` where hteam=\"$away\" and ateam=\"$home\" and mvalue<>'0' and `div`<>'FA' and `div`<>'SA' and `div`<>'IN' order by season desc, mid desc";
	...
	$q2= "";//"select season,date_format(match_date,'%d-%b-%y') as mdate,ateam,`div`,h_s,a_s from `last_season_pred` where hteam='$away' and ateam='$home' and season in ('2009-2010','2008-2009','2007-2008') order by season desc, match_date desc";
