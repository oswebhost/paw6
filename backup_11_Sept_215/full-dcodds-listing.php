	  ...
	  <form method="get" action="<?echo $PHP_SELEF;?>">
       ...
       <td class='rtd'><b><font size="2" color="#0000FF">Sort On</font></b></td>
        ...
        <select size="1" name="SORTBY" class="text" style="width:150px;padding:3px;">
          ...
          <optgroup label="Odds">  
            <option value="10" <?echo selected($_GET['SORTBY'],'10')?>>Home/Draw Odds</option>
            <option value="11" <?echo selected($_GET['SORTBY'],'11')?>>Away/Draw Odds</option>
            <option value="12" <?echo selected($_GET['SORTBY'],'12')?>>Home/Away Odds</option>
          </optgroup>
...
?>
	...
	<tr <?php echo rowcol($number);?>>
	    ...
	    <td class='padd ltd'>
	    	<a title="Results to Date" class='md' href="teamfixt.php?TEAM=<?echo $row['hteam']?>&site=<?echo $db;?>">
...
?>
 ...
 <tr bgcolor="#f4f4f4">
    ...
    <td colspan="1" class="ctd padd bot"><?echo $dcc; ?></td>
  </tr> 
 ...
 <tr bgcolor="#f4f4f4">
    ...
    <td colspan="2" class="ctd padd bot"><?echo num2( ($dcc/$tdc) *100); ?>%</td>
