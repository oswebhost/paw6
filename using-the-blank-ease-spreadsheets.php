...
<p>The following notes have been prepared for those who take their betting seriously and who wish to exercise total discretion and control over the match selections they intend to bet on. </p>
...
<p><B><I>The only difference is that we do all the donkey work involved in testing, running and collating the output from our Program, and we attach that output to a spreadsheet that makes it easy for you to check for yourself what fixtures would be the best ones to bet on (which we call the Blank "<strong>EASE</strong>" spreadsheet). </I></B></p>

<p>To see the backup data on the Blank EASE spreadsheet for the 6 fixtures you are interested in, all you have to do is enter the names of the teams involved in the fixtures.</p>
...
<p>The purpose of the Blank "EASE" spreadsheet is to help you more easily identify those 6 matches that will offer you the best chances of producing the predicted "Correct Scores" as well as the Win results. </p>

<p>We ourselves try to exclude "<B>Outright Favourites</B>" ("Very Short Odds" matches) as much as possible for <b>Correct Scores</b> betting, because otherwise there is a tendency for the range of score-lines to increase considerably, making it less likely for us to be able to nail the score-line.</p>

<p>As an example, take the English Premier matches for 3 of the top ranked teams on 01 November 2008: Chelsea hammered Sunderland 5-0, and Manchester United beat Hull City 4-3.  Now who could have predicted those ridiculous score-lines? Yes, we know this is an old match, but we've been online now for 12 years, and it's the same story every year, just different matches!</p>

<p>On the other hand, some of the Medium Odds "Home Win" calls we may go for might end up as Draws (we are often forced to go this way when the number of solid winners appears more limited), and so we avoid betting Asian Handicap with those particular matches.       </p>
...
<p>Our methodology for selecting which predictions to go for is simple:</p>

<ul	style='padding-left:50px;padding-top:15px;'>
...
<p>As part of our prediction and tracking System we produce a whole series of tables and other charts to accompany our special "<a class="prv" href="team-performance-chart-last.php">Performance Indicator Chart</a>" (PIC), and it therefore makes sense to use as much of that data as we possibly can. For example, amongst many other comparisons, we compare such things as "Goals For" and "Goals Against" for both teams, together with how many wins and losses we predicted compared to what actually happened. And then we compare that data with the "<B>EASE</B>" spreadsheet's "Projected Score-Line".</p>

<p>When we first started doing this, the problem was that the amount of data we had to extract from the <B>PIC</B>'s was absolutely colossal! So in a week where there were over 120 prime matches at the weekend (we covered less Divisions in those days), it would have taken us at least 40 hours to compile and review the details for each and every match, after which we would then still have needed to make selections and process all the data for posting the "<B>EASE</B>" spreadsheet on our website.  This is why we went to all the trouble of semi-automating the "<b>EASE</b>" spreadsheet, so that it now brings forward all the relevant past team performance data just by inserting the fixtures details on the "Match Selections" worksheet.</p>

<p>We now need to explain what the <strong>Projected Score-Line</strong> backup data  represents (Cells Q70:R75 on the "Match Selections" worksheet of the <strong>"Blank" EASE</strong> spreadsheet), i.e. how we compile it and what its relevance is as far as you are concerned:</p>

<ol type='i' style='padding-left:50px'>
	
	<li style='padding-bottom:8px;'>We make predictions of the goals both "for" and "against" each team for each and every match. To make those predictions we use a suite of interconnected algorithms that have been tried, tested and modified for improvement over the course of the past 12 years or so (as of 2015), and which are very good for doing the job they were specifically designed to do.</li>
	...
	<li style='padding-bottom:8px;'>What the Projected Score-Line calculations on our EASE spreadsheets do is take our Program's original Anticipated Score-Line (ASL) and re-work it to compensate for where the Program has not been getting it "quite right". This would normally be due to a team producing a number of score-lines that are somewhat inconsistent when compared against its "averaged" score-lines.</li>
...
<ol type='a' style='padding-left:50px'>
	...
	<li style='padding-bottom:8px;'>If, having completed steps (c) and (d) above, you still decide to keep the Oddballs on board, we recommend that you highlight them accordingly so you won't forget the possible pitfalls when making your final selections, just as we would do if we were offering a posted "<b>EASE 6</b>" spreadsheet for your consumption. </li>
	...
	<p style='padding-left:50px;padding-top:10px;'>[Click on the <B><I>Date/Time</I></B> link adjacent to the fixture you are interested in, then scroll down on the <span class='green'>Team Performance Records</span> to the "Frequency of Goals For/Against" table to review the actual scores history for the current season to date as well as the past season (at the very bottom of the screen).]</p>
	
	</li>

	<li style='padding-bottom:8px;'>One final check you should also make, before convincing yourself too quickly about what the outcome of the match will most likely be, is to re-check where the two teams stand comparatively in the League Division table, both overall and for the respective Home/Away plays (the relevant charts are also found under the <span class='green'>Team Performance Records</span> data).</li>
