...
<body>
<?php page_header("Blank \"EASE\" Spreadsheet") ; ?>

<div class="report_blue_heading" style="width: 530px;margin:0 auto 5px auto;"><?php echo  site('eu');?></div>

<div class='errordiv' style='width:520px;margin:auto auto;text-align:center;border:1px solid #004E9B;'><?php echo $errlog; ?></div>

<p style="color: red;padding-left:88px;padding-right:88px;">If you are not a fully subscribed member, then you will only be able to download those files you see beneath the topmost file.</p>
