...
<a class='none' href="<?php echo $domain;?>/fifa-world-cup-2014.php")"><img src="<?php echo $domain;?>/images/fifa2014.gif" border="0" alt="FIFA World Cup 2014 Predictions"></a>
<div style='margin-bottom:8px;border:0'></div>
...
<?php if (!isset($_SESSION["userid"])){ ?>
	...
	<div class="reg_botton" style="margin-top: 0px;padding-top:12px">
		<a title='Get Soccer Predictions Data Now!' href="<?=$domain ?>/payment_options.php">
		<img src='<?=$domain ?>/images/joinnow3.fw.png' border='0' alt='Get Soccer Predictions Data Now!s'></a>
	</div>
