...
<table border="0">
	...
	<tr>
		<td colspan='3'> <a class='none' href="javascript:bigwin('<?php echo $domain;?>/soccer-predictions-analysis-tool.php?<?php echo $toolurl;?>')"><img src='images/new_big_SoccerPat02.gif' border='0' width='580' alt="Soccer Selections Analysis Tool"></a> </td>
	</tr>
