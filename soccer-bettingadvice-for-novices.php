...
$page_title = "Betting Advice For Novices";

$show_key= meta_bettingadvice();
$desc = "Basic advice for people new to soccer betting to explain the pitfalls of gambling and how best to approach their betting so that they stand the best chance possible of winning without having to risk too much.";
...
<div style='float:right;width:555px;padding:2px;border:1px solid #ccc;background:#f3f3f3;margin-bottom:20px;height:34px;'>
	...
	<form method='post' action='bettingadvice-for-novices.php'>
