...
<table width='100%' border='0' cellpadding='2' cellspacing='0' style="border-collapse: collapse;" bordercolor="black">
	 ...
	 <td valign='top' bgcolor='#FFFFEC' style='border-right:1px solid gray;border-bottom:1px solid gray;'> 
		...
		<?php if ($ddd['hw_x']>0){ ?>
		  ...
		  <table width='100%' border='0' cellspacing='0'>
			<tr>	
		       <td id='xtd'>1 or X</td>
		       <td id='ytd'><?php echo num2($ddd["hw_x"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='xtd'>2 or X</td>
		       <td id='ytd'><?php echo num2($ddd["aw_x"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='xtd'>1 or 2</td>
		       <td id='ytd'><?php echo num2($ddd["hw_aw"]); ?>  </td>
			</tr>
		  </table>
		...
		<?php if($ddd['hw_odd']>0){ ?>
			...
			<table width='100%' border='0'>
				<tr>	
				   ...
				   <td id='ytd'><?php echo num2($ddd["hw_odd"]); ?>  </td>
				</tr>
				<tr>	
				   <td id='xtd'><font color='red'>Away Win</font></td>
				   <td id='ytd'><?php echo num2($ddd["aw_odd"]); ?>  </td>
				</tr>
			</table>
 ...
 <tr>
	<td id='ctd' style='border-left:0'><?php echo bookie_name($ddd['dchance']); ?> </td>
	<td id='ctd'><?php echo bookie_name($ddd['winonly']); ?> </td>
	<td id='ctd' style='border-right:0'><?php echo bookie_name($ddd['underover']); ?> </td>
 </tr>
 ...
 <tr>
	<td  valign='top' align='center'  style='border-left:0' bgcolor='#FFFFEC'>
		 ...
		 <table width='100%' border='0' cellspacing='0'>
			<tr>	
		       <td id='tdxht'>1 / 1</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_hh"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>1 / X</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_hd"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>1 / 2</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_ha"]); ?>  </td>
			</tr>
		  </table>
	</td>
	<td  valign='top' align='center'  style='border-left:1px solid #ccc;' bgcolor='#ECFFEC'>
		 ...
		 <table width='100%' border='0' cellspacing='0'>
			<tr>	
		       <td id='tdxht'>X / 1</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_dh"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>X / X</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_dd"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>X / 2</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_da"]); ?>  </td>
			</tr>
		  </table>
	</td>
		<td  valign='top' align='center' style='border-left:1px solid #ccc;' bgcolor='#FFFFEC'>
		 ...
		 <table width='100%' border='0' cellspacing='0'>
			<tr>	
		       <td id='tdxht'>2 / 1</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_ah"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>2 / X</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_ad"]); ?>  </td>
			</tr>
			<tr>	
		       <td id='tdxht'>2 / 2</td>
		       <td id='tdyht'><?php echo num2($ddd["ht_aa"]); ?>  </td>
			</tr>
		  </table>
	</td>
 </tr>
  <tr>
		<td colspan='3' class='ctd' style='border-top:1px solid #ccc;'>Odds provided courtesy of 
			<?php echo bookie_name($ddd['ht_book']); ?>
		</td>
  </tr>
<?php } ?>
...
<table width='80%' border='0' cellpadding='4' cellspacing='0' style="border-collapse: collapse;" bordercolor="gray">
 <tr bgcolor="#f4f4f4">
	...
	<tr bgcolor='#FFFFEC'>
		 <td width='30%' id='tdxx' style='text-align:right'>
		 	<?php echo $_SESSION['home'] .  ' (' . num2($ahb['ht_hcap']) . ')';  ?>
	 	</td>
		 <td width='20%' id='tdxx' style='text-align:center;'>
		 	<?php echo num2($ahb["ht_odd"]) . ' - ' . num2($ahb["at_odd"]); ?>
	 	</td>
		 <td width='30%' id='tdxx'>
		 	<?php echo $_SESSION['away'] .  ' (' . num2($ahb['at_hcap']) . ')';   ?>
		 </td>
