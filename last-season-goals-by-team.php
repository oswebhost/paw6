...
<?php if ($loc =="Home" ){ ?>
	  ...
	  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#CDCDCD" width="100%">
	   <tr><td colspan='3' class='ctd'><B>When Home: <?php echo $cap?></B>
	   <?php
	  ...
	  $query1 = "SELECT h_s, a_s FROM `last_season_pred` WHERE hteam=\"$TEAM\" and season='$last_season'";
	  if ($db=='eu'){
	  ...
	  $temp->execute();	  
		...
		for ($i=0; $i<=6; $i++){			echo "<tr " . rowcol($i) . ">\n";
...
<?php }else{ ?>
	  ...
	  <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#CDCDCD" width="100%">
	   ...
	   <tr><td colspan='3' class='ctd'><B>When Away: <?php echo $cap?></B>
	   <?php
	  ...
	  <?php
	  $query1 = "SELECT h_s, a_s FROM `last_season_pred` WHERE ateam=\"$TEAM\" and season='$last_season'";
