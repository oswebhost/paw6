...
<? page_header("$page_title") ; ?>
        ...
        <font size="3" color="#0000FF"><b><i>Current Week's Fixtures &amp; Predictions</i></b></font>
	     ...
	     <?php if (!isset($_SESSION["userid"])){ ?>
	 		...
	 		<div class='errordiv' style='margin-top:10px;font-size:14px;'>
	 			
	 		  
			   <b>NOTE:</b> You will <span class='red'>NOT</span> be able to access the Current Week's Predictions Data <span class='bb'>unless you are a Subscribing Member</span>, but you will be able to review the predictions for all Past Weeks for this Season. If you want to see the past records for earlier Seasons, please check the "Prediction Performance Records" under the GENERAL DATA menu below.<br />
		...
		<table border="1" width="570" align="center" bordercolor="#EBEBF3" cellspacing="0" style="border-collapse: collapse" cellpadding="4">
			...
			<tr>
				<td width="50%" >
				<?php if  (gg_count('EP','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td width="50%" >
				<?php if  (gg_count('C0','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td>
				<?php if  (gg_count('C1','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('C2','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				...
				<td colspan='2'>
				<?php if  (gg_count('FA','n/a','FIXTURE')>0) :
						 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
        ...
        <tr>
        	...
        	<td>
				<?php if  (gg_count('NC','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('RP','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
        	...
        	<td>
				<?php if  (gg_count('MP','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('UP','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td>
				<?php if  (gg_count('SP','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('S1','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('S2','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td>
				<?php if  (gg_count('S3','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td colspan="2">
				<?php if  (gg_count('SA','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
		...
		<tr>
			...
			<tr>
				...
				<td width="50%">
				<?php if  (gg_count('FL','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td width="50%">
				<?php if  (gg_count('GB','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<td width="50%">
				<?php if  (gg_count('G0','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
				...
				<td width="50%">
				<?php if  (gg_count('HK','n/a','FIXTURE')>0) :
						 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td width="50%">
				<?php if  (gg_count('IS','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<td width="50%">
				<?php if  (gg_count('P0','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td width="50%"> 
				<?php if  (gg_count('SL','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<td width="50%"> 
				<?php if  (gg_count('T0','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
            ...
            <tr>
				<td width="50%"> 
				<?php if  (gg_count('BRA','n/a','FIXTURE','sa')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<td width="50%"> 
				<?php if  (gg_count('BRB','n/a','FIXTURE','sa')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
            ...
            <tr>
				<td colspan="3"> 
				<?php if  (gg_count('MLS','n/a','FIXTURE','sa')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
			...
			<tr>
				<td colspan='2'>
				<?php if  (gg_count('IN','n/a','FIXTURE')>0) :
					 $cla="mblue" ;
				   else:
					 $cla="red" ;
				   endif;
