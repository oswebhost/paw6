...
require_once("header_pic.ini.php");
...
<table width='98%' border='1' cellpadding='2' cellspacing='0' style="border-collapse: collapse;" bordercolor="gray"> 
	<tr bgcolor="#f4f4f4" height='25'>
		<td colspan='10' class='ctd' ><font class='credit'><font color='blue'><?php echo $home;?></font> v <font color='red'><?php echo $away;?></font> Match Details</font></td>
	</tr>
		<tr bgcolor="#D3EBAB">
	...
	<tr>
		<td  style='text-align:center;font-weight:bold;'>
			<?php echo $d["m_date"] . "&nbsp;<font size='1'>" . substr($d['match_time'],0,5) . "</font>"; ?> 
		</td>
		<td style='text-align:center;font-weight:bold;'>
			<?php echo $d['div'] ;?> 
		</td>
		...
		<td style='text-align:center;font-weight:bold;' bgcolor='#D2D2FF'> <?php echo $d['hwinpb']; ?> </td>
		<td style='text-align:center;font-weight:bold;' bgcolor='#DFFFDF'> <?php echo $d['drawpb']; ?> </td>
		<td style='text-align:center;font-weight:bold;' bgcolor='#FFB0B0'> <?php echo $d['awinpb']; ?> </td>
		<td style='text-align:center;font-weight:bold;'> <?php echo ($d['h_odd']>0? $d['h_odd'] : '') ;?> </td>
		<td style='text-align:center;font-weight:bold;'> <?php echo ($d['d_odd']>0? $d['d_odd'] : '') ;?> </td>
		<td style='text-align:center;font-weight:bold;'> <?php echo ($d['a_odd']>0? $d['a_odd'] : '') ;?> </td>
		<td style='text-align:center;font-weight:bold;'> <?php echo ($d['asl_odd']>0?$d['asl_odd'] : '') ;?> </td>
	</tr>
	<tr height='20'>
...
<table border='0' cellpadding='0' cellspacing='0' width='98%' style='border:1px solid #FF0000;'> 
	<tr height='35'>	
		<td width='95%' bgcolor="#f4f4f4" style='text-align:center;border-bottom:1px solid gray;'> 
				...
				<FONT SIZE="1" >Odds provided courtesy of <?php echo bookie_name("BET");?> </FONT>
				
		</td>
		<td class='rtd' bgcolor="#f4f4f4" style='text-align:center;border-bottom:1px solid gray;'>
			<a class='sbar' href="javascript:tell('full_odds.php?id=<?php echo $_GET['id'];?>&db=<?php echo $db;?>')">more...</a> 
		</td>
	</tr>
	<tr >
		<td colspan='2'>
			<?php  require_once ("cs_odds.php");  ?>
		</td>
	</td>
</table>
...
<table border='0' cellpadding='0' cellspacing='0' width='98%' style='border:1px solid #FF0000;'> 
	...
	<tr >
		<td>
			<?php require_once ("other_odds.php"); ?>
...
<!-- Current Leauge Standing -->
    ...
    <?php 
      ...
      if ($home_div==$away_div){
        ...
        $weekno=$cur_wk; 
        $wk = max_tab_week($sea) ;  
        $t_url = "$home_div,$weekno,$sea,$last_season,,$_SESSION[home],$_SESSION[away]"; 
    ...
    <table border='0' cellpadding='2' cellspacing='0' style='border:1px solid blue;' width='98%' style="border-collapse: collapse"> 
    	...
    	<tr>
    	   ...
    	   <ul id="countrytabs" class="shadetabs" style='margin:0px;padding:0'>
    			...
    			<li><a href="ltable-rank-home.php?t_url=<?php echo $t_url;?>" rel="countrycontainer">Home</a></li>
    			<li><a href="ltable-rank-away.php?t_url=<?php echo $t_url;?>" rel="countrycontainer">Away</a></li>
    	   </ul>
  		   </td> 
	  ...
	  <script type="text/javascript">
	   ...
	   <?php if ($home_div=="MLS")
	   { 
	   		$t_url = "$home_div,$weekno,$sea,$last_season,EC";    
	   	?>
			   ...
			   <table border='0' cellpadding='2' cellspacing='0' style='border:1px solid blue;margin-top:4px;' width='98%' style="border-collapse: collapse"> 
				...
				<tr>
				   ...
				   <ul id="countrytabs1" class="shadetabs" style='margin:0px;padding:0'>
						<li><a href="#" rel="#default" class="selected">Overall</a></li>
						<li><a href="ltable-rank-home.php?t_url=<?php echo $t_url;?>" rel="countrycontainer1">Home</a></li>
						<li><a href="ltable-rank-away.php?t_url=<?php echo $t_url;?>" rel="countrycontainer1">Away</a></li>
				   </ul>
				   </td> 
			...
			<?php 
				...
				$t_url = "$home_div,$weekno,$sea,$last_season,WC"; 
			?>
			   <table border='0' cellpadding='2' cellspacing='0' style='border:1px solid blue;margin-top:4px;' width='98%' style="border-collapse: collapse"> 
				<tr>
					<td colspan='2' style='text-align:center;padding:5px;border-bottom:1px solid gray;'  bgcolor="#f4f4f4">
				...
				<tr>
				   ...
				   <ul id="countrytabs2" class="shadetabs" style='margin:0px;padding:0'>
						<li><a href="#" rel="#default" class="selected">Overall</a></li>
						<li><a href="ltable-rank-home.php?t_url=<?php echo $t_url;?>" rel="countrycontainer2">Home</a></li>
						<li><a href="ltable-rank-away.php?t_url=<?php echo $t_url;?>" rel="countrycontainer2">Away</a></li>
				   </ul>
				   </td> 
...
<table border='0' cellpadding='0' cellspacing='0' width='100%' style="border-collapse: collapse"> 
	<tr>	
		<td  style='text-align:center;padding-left:0px;padding-right:0px;' valign='top'> 
			<?php  if (is_file($file)): require_once($file);  endif;  ?>
		</td>
	</tr>
</table>
...
<table border='0' cellpadding='1' cellspacing='0' style='border:1px solid blue;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td width='50%' style='text-align:center' >  <b><FONT COLOR="blue"><?php echo strtoupper($home); ?></FONT></b> 
		<?php 
		...
		<td width='50%' style='text-align:center' > <b><FONT COLOR="red"><?php echo strtoupper($away); ?></FONT></b>
		<?php 
	...
	<tr>
		<td style='text-align:center' valign='top'> <?php $loc = "Home" ; require("headtohead2.php"); ?> </td>
		<td > </td>
		<td style='text-align:center' valign='top'> <?php $loc = "Away" ; require("headtohead2.php"); ?> </td>
	</tr>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top'> <?php $loc ="Home"; require("results-by-team.php"); ?> </td>
		<td > </td>
		<td style='text-align:center' valign='top'> <?php $loc ="Away"; require("results-by-team.php"); ?> </td>
	</tr>
	<tr height='20'>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top'> <?php $loc ="Home"; require("results-by-team2.php"); ?> </td>
		<td > </td>
		<td style='text-align:center' valign='top'> <?php $loc ="Away"; require("results-by-team2.php"); ?> </td>
	</tr>
	<tr height='20'>
		<td colspan='3' style='text-align:center' > 
		<font color='red'> Act. Score</font> = Actual Score</font>&nbsp;&nbsp;|&nbsp;&nbsp;
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF00FF;' width='98%' style="border-collapse: collapse"> 
	...
	<tr height='20'>
		<td colspan='3' style='text-align:center'  bgcolor="#f4f4f4"> <font class='credit'>Prediction Accuracy This Season for Home Team <font color='blue'><?php echo $home;?></font> </font> 
		<?php 
			if ($hrank=="rel"): echo "<i> [Relegated] </i>"; endif;
		    if ($hrank=="prom"): echo "<i> [Promoted] </i>"; endif;
		?>
	...
	<tr>
		<td style='text-align:center' valign='top'>
			<?php  require("prediction-accuracy.php"); ?> </td>
		</td>
	</tr>
	...
	<tr height='20'>
		<td colspan='3' style='text-align:center'  bgcolor="#f4f4f4"> <font class='credit'>Prediction Accuracy This Season for Away Team <FONT COLOR="red"><?php echo $away;?></FONT> </font> 
		<?php 
	...
	<tr>
		<td style='text-align:center' valign='top'>
			<?php require("prediction-accuracy-away.php");  ?> </td>
		</td>
	</tr>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top' colspan='2' width='48%'>

			<?php $loc = "Home"; require("goals-lines-by-team.php"); ?>
		</td>
		<td width='2%'></td>
		<td style='text-align:center' valign='top' colspan='2' width='48%'>
			<?php $loc = "Away"; require("goals-lines-by-team.php"); ?>
		</td>
	</tr>
	
	<tr>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Home"; require("goals-by-team.php"); ?>
		</td>
		<td width='2%'></td>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Away"; require("goals-by-team.php"); ?>
		</td>
	</tr>
</table>
...
<!-- home and away -->
	<tr >
		<td width='48%' style='text-align:center'><b><FONT COLOR="blue"><?php echo $home ?></FONT></b>
		 <?php 
		 	if ($hrank=="rel"): echo "<i> [Relegated] </i>"; endif;
		  	if ($hrank=="prom"): echo "<i> [Promoted] </i>"; endif;
		?>
		...
		<td width='48%' style='text-align:center'> <b><FONT COLOR="red"><?php echo $away ?></FONT></b> 
		 <?php 
		 	if ($arank=="rel"): echo "<i> [Relegated] </i>"; endif;
		  	if ($arank=="prom"): echo "<i> [Promoted] </i>"; endif;
		?>
...
<!-- away and home -->
	...
	<tr>
		<td valign='top' style='padding-left:5px;text-align:center'><IMG SRC="Rt-bar-all.php?<?php echo bar_data($home,"Away",$db);?>" BORDER="0"  alt=''> </td>
		<td > </td>
		<td align='center' valign='top'><IMG SRC="Rt-bar-all.php?<?php echo bar_data($away,"Home",$db);?>" BORDER="0"  alt=''> </td>
	</tr>
...
<!-- over all -->
	...
	<tr>
		<td valign='top' style='padding-left:5px;text-align:center'><IMG SRC="Rt-bar-all.php?<?php echo bar_data($home,"All",$db);?>" BORDER="0"  alt=''> </td>
		<td > </td>
		<td align='center' valign='top'> <IMG SRC="Rt-bar-all.php?<?php echo bar_data($away,"All",$db);?>" BORDER="0"  alt=''> </td>
	</tr>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top'> 
			<?php $loc ="Home"; require("results-by-team-last.php"); ?> 
		</td>
		<td > </td>
		<td style='text-align:center' valign='top'> 
			<?php $loc ="Away"; require("results-by-team-last.php"); ?> 
		</td>
	</tr>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top'> 
			<?php $loc ="Home"; require("results-by-team-last2.php"); ?> 
		</td>
		<td > </td>
		<td style='text-align:center' valign='top'>
			<?php $loc ="Away"; require("results-by-team-last2.php"); ?> 
		</td>
	</tr>
...
<table border='0' cellpadding='2' cellspacing='0' style='border:1px solid #FF9900;' width='98%' style="border-collapse: collapse"> 
	...
	<tr>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Home"; require("lastseason-goals-lines-by-team.php"); ?>
		</td>
		<td width='2%'></td>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Away"; require("lastseason-goals-lines-by-team.php"); ?>
		</td>
	</tr>
	<tr>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Home"; require("last-season-goals-by-team.php"); ?>
		</td>
		<td width='2%'></td>
		<td style='text-align:center' valign='top' colspan='2' width='49%'>
			<?php $loc = "Away"; require("last-season-goals-by-team.php"); ?>
		</td>
	</tr>
...
require_once("footer_pic.ini.php");
