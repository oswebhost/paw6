...
//http://soccer-predictions.com/soccer-predictions-analysis-tool.php?db=eu&season=2014-2015&weekno=14&DIV=0&BETTING=1&SORTBY=11&ordered=1&PERIOD=1&CALL=8&PROPTION=2&ASL2GET=all&limitedto=12&min_odd=3.00&max_odd=3.20&CALLPARAM=0&CALLAS=4&B1=View+Data
...
if ($db=='sa'){
  ...
  //$pat_url = "db=eu&season=2014-2015&DIV=0&BETTING=1&SORTBY=13&ordered=1&PERIOD=1&CALL=3&min_odd=0.00&max_odd=0.00&limitedto=6&PROPTION=1&CALLPARAM=0&B1=View+Data&weekno=" .$wk_to_show ;
   ...
   $pat_url = "db=eu&season=2014-2015&DIV=0&BETTING=1&SORTBY=13&ordered=1&PERIOD=1&CALL=3&PROPTION=1&ASL2GET=all&limitedto=6&min_odd=0.00&max_odd=0.00&CALLPARAM=0&CALLAS=0&weekno=" .$wk_to_show ;
}else{
		  ...
		  <tr>
		   ...
		   <?php if ($_GET['BETTING']==1 and $_GET['CALL']==1){ ?>
			...
			<td>	
				<select size="1" name="CALLAS" class="text" style="width:140px;padding:3px;" >
				   <option value="0" <?echo selected($_GET['CALLAS'],'0')?>>No Reverse Call</option> 
                   <option value="12" <?echo selected($_GET['CALLAS'],'12')?>>Calls as Away Wins</option>
...
function revCall($no,$secondPara){
	...
	if ($secondPara < 4){
		...
		{	
			...
			case 12: $rvcall = "Call as Away Wins"; break;
			case 13: $rvcall = "Call as Home Wins"; break;
			case 14: $rvcall = "Call as Draws"; break;
		}
