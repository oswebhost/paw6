       ...
       <tr>
            ...
            <td class='rtd'><b><font size="2" color="#0000FF">PaW Call Type</font></b></td>
    		  ...
    		  <select size="1" name="CALL" class="text" style="width:120px;padding:3px;">
               <option value="0" <?php echo selected($_GET['CALL'],'0')?>>All Calls</option> 
...
?>
	...
	<tr <?php echo rowcol($number);?>>
		...
		<td <?php echo ($_GET["SORTBY"]=='14'? "bgcolor='#D3EBAB'": "");?> class="ctd <?php echo $asl_class . $pr;?>"><?php echo $row['hgoal'] . dash() . $row['agoal'];?></td>
...
?>
 ...
 <tr bgcolor="#f4f4f4">
    ...
    <td colspan="2" class="ctd padd bot"><?php echo num2(($ngot/($number-$postponed))*100) ."%" ; ?></td>
