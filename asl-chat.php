...
//	echo "select * from csodd_table where odds='$odd_cat' and asl='$match_asl' order by outcome";
	...
	$info = matrix();
	$info = preg_replace("/%match_asl%/", "$h_asl-$a_asl", $info);
    $content='';
	$col = 0;
...
<table border="0" cellpadding="0" style="border-collapse: collapse" width="500" bordercolor="#008000">
	...
	<tr>
		<td class="mytd3 ctd" bgcolor="#75A4DD"><?php echo num2($datay[0]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#95B3D7"><?php echo num2($datay[1]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#8DB4E3"><?php echo num2($datay[2]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#B8CCE4"><?php echo num2($datay[3]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#C5D9F1"><?php echo num2($datay[4]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#DFFFDF"><?php echo num2($datay[5]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#F2DDDC"><?php echo num2($datay[6]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#FCD5B4"><?php echo num2($datay[7]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#E6B9B8"><?php echo num2($datay[8]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#FAC090"><?php echo num2($datay[9]);?>%</td>
		<td class="mytd3 ctd" bgcolor="#D99795"><?php echo num2($datay[10]);?>%</td>
	</tr>
	<tr>
...
<div align="center">
	<table border="1" cellpadding="0" style="border-collapse: collapse" width="300" bordercolor="#008000" cellspacing="0" class="mytd6">
		<tr>
			<td colspan="3" class="mytd" bgcolor="#EFF5FA">Likelihood of Goal Difference for <?php echo "$h_asl-$a_asl"; ?> Prediction</td>
		</tr>
		<tr>
			<td colspan="3" class="mytd" bgcolor="#F6F6F6">Likelihood of a Draw = <?php echo $datay[5];?>%</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="mytd7"><?php echo  num2($h_value+$datay[4]+$datay[3]+$datay[2]+$datay[1]+$datay[0]); ?>%</td>
			<td class="mytd7"><?php echo  num2($a_value+$datay[6]+$datay[7]+$datay[8]+$datay[9]+$datay[10]); ?>%</td>
		</tr>
		<tr>
			<td class="mytd8" bgcolor="#EFF5FA">2 Goals =</td>
			<td class="mytd7" bgcolor="#EFF5FA"><?php echo  num2($h_value+$datay[3]+$datay[2]+$datay[1]+$datay[0]); ?>%</td>
			<td class="mytd7" bgcolor="#EFF5FA"><?php echo  num2($a_value+$datay[7]+$datay[8]+$datay[9]+$datay[10]); ?>%</td>
		</tr>
		<tr>
			<td class="mytd8">3 Goals =</td>
			<td class="mytd7"><?php echo  num2($h_value+$datay[2]+$datay[1]+$datay[0]); ?>%</td>
			<td class="mytd7"><?php echo  num2($a_value+$datay[8]+$datay[9]+$datay[10]); ?>%</td>
		</tr>
		<tr>
			<td class="mytd8" bgcolor="#EFF5FA">4 Goals =</td>
			<td class="mytd7" bgcolor="#EFF5FA"><?php echo  num2($h_value+$datay[1]+$datay[0]); ?>%</td>
			<td class="mytd7" bgcolor="#EFF5FA"><?php echo  num2($a_value+$datay[9]+$datay[10]); ?>%</td>
		</tr>
		<tr>
			<td class="mytd8">5 Goals =</td>
			<td class="mytd7"><?php echo  num2($h_value+$datay[0]); ?>%</td>
			<td class="mytd7"><?php echo  num2($a_value+$datay[10]);?>%</td>
		</tr>
		<?php
